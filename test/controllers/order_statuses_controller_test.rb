...
class OrderStatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_status" do
    assert_difference("OrderStatus.count") do
      post order_statuses_url, params: { order_status: { created_at: @order_status.created_at, name: @order_status.name, updated_at: @order_status.updated_at } }
    end
  ...
  test "should update order_status" do
    patch order_status_url(@order_status), params: { order_status: { created_at: @order_status.created_at, name: @order_status.name, updated_at: @order_status.updated_at } }
